...
const CardWrapper: React.FC<{ children: React.ReactNode; href: string }> = ({
  children,
  href,
}) => (
  <Link href={href}>
    <motion.div
      ...
      whileHover={{
        scale: 1.03,
        boxShadow: "0 8px 30px rgba(10, 47, 53, 0.2)",
      }}
...
export const ImageTemplate: React.FC = () => {
  return (
    <CardWrapper href="/dashboard/Image">
      <div className="flex justify-between items-start mb-4">
        <Image
          src="https://cdn-icons-png.flaticon.com/128/13963/13963246.png"
          alt="Image Generator Icon"
...
export const CustomGeneratorTemplate: React.FC = () => {
  return (
    <CardWrapper href="/dashboard/custom-template">
      <div className="flex justify-between items-start mb-4">
        <Image
          src="https://cdn-icons-png.flaticon.com/128/13963/13963247.png"
          alt="Custom Generator Icon"
          width={50}
          height={50}
          className="rounded-sm"
        />
      ...
      <div>
        ...
        <p className="text-text line-clamp-3 text-sm">
          Create unique content with our custom generation tool, tailored to
          your needs.
        </p>
      </div>
    </CardWrapper>
...
export const Translate: React.FC = () => {
  return (
    <CardWrapper href="/dashboard/translate">
      <div className="flex justify-between items-start mb-4">
        <Image
          src="https://cdn-icons-png.flaticon.com/128/2793/2793765.png"
          alt="Audio Extracter Icon"
          width={50}
          height={50}
          className="rounded-sm"
        />
...
export const Voice: React.FC = () => {
  return (
    <CardWrapper href="/dashboard/Voice">
      <div className="flex justify-between items-start mb-4">
        <Image
          src="https://cdn-icons-png.flaticon.com/128/7650/7650580.png"
          alt="Voice Generator Icon"
          width={50}
          height={50}
          className="rounded-sm"
        />
      ...
      <div>
        <h2 className="font-bold text-xl mb-2 text-prim">
          Voice Content Generator
        </h2>
        <p className="text-black line-clamp-3 text-sm">
          Create unique content with our custom generation tool, tailored to
          your needs. Using Your Voice Command
        </p>
      </div>
    </CardWrapper>
  );
...
export const Entity: React.FC = () => {
  return (
    <CardWrapper href="/dashboard/entity">
      <div className="flex justify-between items-start mb-4">
        <Image
          src="https://cdn-icons-png.flaticon.com/128/16466/16466015.png"
          alt="Voice Generator Icon"
          width={50}
          height={50}
          className="rounded-sm"
      ...
      <div>
        ...
        <p className="text-black line-clamp-3 text-sm">
          Find the entity from a Paragraph and get the content from the
          Wikipedia.
        </p>
      </div>
    </CardWrapper>
...
export const Food: React.FC = () => {
  return (
    <CardWrapper href="/dashboard/food">
      <div className="flex justify-between items-start mb-4">
        <Image
          src="https://cdn-icons-png.flaticon.com/128/2414/2414398.png"
          alt="Voice Generator Icon"
          width={50}
          height={50}
          className="rounded-sm"
      ...
      <div>
        ...
        <p className="text-black line-clamp-3 text-sm">
          Get Recommended food to eat based on your mood.
        </p>
      </div>
    </CardWrapper>
  );
...
export const Disease: React.FC = () => {
  return (
    <CardWrapper href="/dashboard/disease">
      <div className="flex justify-between items-start mb-4">
        <Image
          src="https://cdn-icons-png.flaticon.com/128/2968/2968727.png"
          alt="Voice Generator Icon"
          width={50}
          height={50}
          className="rounded-sm"
      ...
      <div>
        ...
        <p className="text-black line-clamp-3 text-sm">
          Predict the Disease using ai So you can be Cautious.
        </p>
      </div>
    </CardWrapper>
  );
