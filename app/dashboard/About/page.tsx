    ...
    <div className="flex flex-col min-h-[100dvh] bg-back text-text">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:items-center">
            <div className="space-y-4">
              ...
              <p className="max-w-[600px] text-lg">
                Discover the power of AI-driven content creation. Our platform
                helps you generate high-quality, engaging content with ease.
              </p>
              <div>
                <Button
                  className="bg-prim text-back border-2 border-prim hover:bg-acc"
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="bg-second">
                <CardContent className="p-6">
                  ...
                  <p>
                    Generate high-quality content in seconds with our advanced
                    AI algorithms.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-second">
                <CardContent className="p-6">
                  ...
                  <p>
                    Work seamlessly with your team using our intuitive
              ...
              <Card className="bg-second">
                <CardContent className="p-6">
                  ...
                  <p>
                    Never run out of ideas with our AI-powered brainstorming
                    assistant.
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-prim/75">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold text-center text-back mb-12">
              Our Process
            </h2>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                {image:"/n.jpg", name: "Nawaz Wariya", role: "CEO & Senior Developer" },
                {image:"/t.jpg", name: "Shaikh Tabish", role: "CTO" },
                {image:"/m.jpg", name: "Mustafa Shaikh", role: "Marketing Manager" },
                {image:"/z.jpg", name: "Mohammed Zaid Shaikh", role: "Lead Designer" },
              ].map((member, index) => (
            ...
            <div className="grid gap-10 lg:grid-cols-2 items-center">
              <div className="space-y-4">
                ...
                <p className="max-w-[600px] text-text md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ...
                  Contentify to streamline their workflow and create amazing
                  content.
                </p>
                <Button
                  className="bg-prim text-back hover:bg-acc"
                  style={{ cursor: "url(/poin.png), auto" }}
                >
