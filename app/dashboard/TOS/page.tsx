          ...
          <div className="space-y-8">
            <section id="user-responsibilities">
              ...
              <p className="text-muted-foreground">
                ...
                the security of your account and password. You agree to use our
                services only for lawful purposes and in accordance with these
                terms of service. You are responsible for your own content and
            ...
            <section id="intellectual-property">
              ...
              <p className="text-muted-foreground">
                All content and intellectual property on our platform, including
                but not limited to text, graphics, logos, and software, are
                owned by Acme Inc. or its licensors. You may not modify, copy,
                distribute, transmit, display, reproduce, or create derivative
                works from our intellectual property without our prior written
                consent.
              </p>
            </section>
            <section id="privacy">
              ...
              <p className="text-muted-foreground">
                We take the privacy of our users seriously. We collect and use
            ...
            <section id="dispute-resolution">
              ...
              <p className="text-muted-foreground">
                ...
                service or your use of our services shall be resolved through
                binding arbitration in accordance with the rules of the American
                Arbitration Association. The arbitration shall be conducted in
                the English language and the award shall be final and binding on
                the parties.
              </p>
            </section>
          </div>
