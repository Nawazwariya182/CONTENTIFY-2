      ...
      <Card className="mb-6">
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl text-prim font-bold mb-2">History</h1>
            ...
            >
              <RefreshCcw
                className={`w-4 h-4 text-prim ${isLoading ? "animate-spin" : ""}`}
              />
      ...
      <Card className="mb-4">
        <CardContent className="p-0">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="text-prim">Template</TableHead>
                <TableHead className="text-prim">AI Response</TableHead>
                <TableHead className="text-prim">Copy</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {isLoading ? (
                ...
                historyData.map((item) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell>
                      ...
                      >
                        <ClipboardCopy className="w-4 h-4 mr-2 text-prim" />
                        Copy
                      </Button>
                    </TableCell>
                  </TableRow>
